...
Business Summary: Used for Student Recruitment report.
    Powers the heat map and the student export.
  
Comments:
2016-08-01  8:00am      Matt         Created
2020-03-10  12:45pm     AGonzalez    Refactored
2020-05-07  3:00PM      sxiong      Remove index table and replace with corresponding raw fields
*********************************************************************/
...
LEFT JOIN custom.schoolmint_ApplicationStatuses stat
    ON stat.status = raw.Application_Status
INNER JOIN custom.SchoolMint_SchoolCodes sc
    ON sc.SchoolMint_SchoolID = raw.School_Applying_to
GO
