...
SELECT  
   ...
   , CASE 
      WHEN raw1.Application_ID <> ISNULL(back1.Application_ID, 999999) THEN 'NEW'
      WHEN raw1.[Application_Status] = back1.[Application_Status] THEN 'NonStatusChange'
      WHEN raw1.[Application_Status] = ISNULL(back1.[Application_Status], raw1.[Application_Status]) THEN 'StatusUpdate'
      WHEN raw1.[Application_Status] <> ISNULL(back1.[Application_Status], 999) THEN 'StatusChange'
     END
